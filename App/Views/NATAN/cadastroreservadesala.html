              ...
              <div class="col-md-3"></div>
                <div class="row"> <!-- Inicio Linha 01 -->
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <input type="datetime" class="form-control" placeholder="Data e horário da reserva">
                    </div>
                  </div><!-- form group-->
                </div> <!-- Fim Linha 01 -->
                <div class="col-md-3"></div>
                  <div class="row">
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <input type="text" class="form-control" placeholder="Professor que reservou a sala">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3"></div>
