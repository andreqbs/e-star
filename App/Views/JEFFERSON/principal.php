      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview"><!--Inicio da aba ALUNO-->
          ...
          <ul class="treeview-menu">
            <li><a onclick="carregar('Acompanhar.php')" href="#"><i class="fa fa-eye"></i>Acompanhar</a></li>
            <li><a onclick="carregar('BuscaAluno.php')" href="#"><i class="fa fa-search"></i>Buscar</a></li>
        ...
        <li class="treeview"><!--Inicio da aba PROFESSOR-->
          ...
          <ul class="treeview-menu">
            <li><a onclick="carregar('notificacaoProf.php')" href="#"><i class="fa fa-bell"></i>Notificações</a></li>
            <li><a onclick="carregar('BuscaProf.php')" href="#"><i class="fa fa-search"></i>Buscar</a></li>
        ...
        <li class="treeview"><!--Inicio da aba TCC-->
          ...
          <ul class="treeview-menu">
            <li><a onclick="carregar('cadastrotcc.php')" href="#"><i class="fa fa-floppy-o"></i>Cadastrar</a></li>
            <li><a onclick="carregar('BuscaTCC.php')" href="#"><i class="fa fa-search"></i>Buscar</a></li>
        ...
        <li class="treeview"><!--Inicio da aba Eventos-->
          ...
          <ul class="treeview-menu">
            <li><a onclick="carregar('BuscaEventos.php')" href="#"><i class="fa fa-search"></i>Buscar</a></li>
        ...
        <li class="treeview"><!--Inicio da aba Defesa de TCC-->
          ...
          <ul class="treeview-menu">
            <li><a onclick="carregar('BuscaDefTCC.php')" href="#"><i class="fa fa-search"></i>Buscar</a></li>
        ...
        <li class="treeview"><!--Inicio da aba Relatórios de TCC-->
          ...
          <ul class="treeview-menu">
            <li><a onclick="carregar('cadastroRelTCC.php')" href="#"><i class="fa fa-floppy-o"></i>Cadastrar</a>
            <li><a onclick="carregar('BuscaRelatTCC.php')" href="#"><i class="fa fa-search"></i>Buscar</a></li>
