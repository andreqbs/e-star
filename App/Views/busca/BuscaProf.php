...
<div class="container-fluid"><!--Conteudo-->
  ...
  <div class="content"><!-- Contém o conteúdo da página -->
          ...
          <thead>
            ...
            <tr><!-- Linha02  --> 
             <td>Ipsum</td>       
              ...
              <td>
                  <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModalBuscaProf"> Visualizar </a>
                  <a href="#" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#myModalEditarProf"> Editar </a>
                  <a href="#" class="btn btn-danger btn-xs" > Excluir </a>
    ...
    <!-- Modal Editar TCC-->
    <div class="modal modal-success" id="myModalEditarProf" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal-header" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
$(".dropdown-menu li a").click(function(e){
  ...
  $('#search-form').on('submit', function(){
                    ...
                    ajaxPostRedirect(dataString,"BuscaProfAPI.php");
